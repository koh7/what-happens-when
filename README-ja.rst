...
このリポジトリは「あなたのブラウザのアドレスにgoogle.comとタイプしてエンターを押したとき何が起こっているか」という古びたインタビュー質問に答えるためのものだ。

退屈なストーリーを語るんじゃなく、できる限り詳細にこの質問に回答していく。スキップはなしだ。

これには皆の協力が必要だ。だから覚悟をして、また手を貸してくれ。色んな部分は不完全だから君がそれを補ってくれるのを待っている。プルリクエストを送ってくれ!

このプロジェクトは`Creative Commons Zero`_ licenseの条項に基づいてライセンスされている。
